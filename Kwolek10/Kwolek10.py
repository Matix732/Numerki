...
# Obliczenie wag dla interpolacji Hermite'a
# uwzględniającą wartości funkcji w punktach x
# oraz wartości pochodnych funkcji w tych punktach
...
def fh_interpolation_function(x, weights, x_array, y_array):  
    if x in x_array:
        return function(x)
...
# Konstrukcja wykresu
plt.scatter(x_array, y_array, color="RED", label="Calculated points")
